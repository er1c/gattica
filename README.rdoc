...
Data is comma-separated and double-quote delimited.
...
1. The option to use a custom delimiter for output
2. Automatically handle paging (the API only returns 1000 results at a time)
3. Create a nice syntax for filters
