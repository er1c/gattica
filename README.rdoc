# TODO: Mention that user can manually set additional headers for HTTP requests
# TODO: User can pass their own Logger object in when they create an instance of Gattica
